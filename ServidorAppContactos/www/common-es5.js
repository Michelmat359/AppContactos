...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /*! exports provided: ContactsProvider */
  ...
  function srcAppServicesContactsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "ContactsProvider", function () {
    ...
    var ContactsProvider = /*#__PURE__*/function () {
      function ContactsProvider() {
        _classCallCheck(this, ContactsProvider);

        this.id = 0;
        this.contacts = [];
        this.addContact({
          email: 'mimaca1@inf.upv.es',
          name: 'Miguel Angel',
          surname: 'Mateo Casali'
        });
        this.addContact({
          email: 'lamoru@bbaa.upv.es',
          name: 'Laura',
          surname: 'Moya Ruiz'
        });
        this.addContact({
          email: 'anonimo@upv.es',
          name: 'Anon',
          surname: 'Imo'
        });
      } //Añadir
      ...
      _createClass(ContactsProvider, [{
        ...
        key: "listContactById",
        value: function listContactById(id) {
        ...
        key: "listContacts",
        value: function listContacts(query) {
          var result = this.contacts;

          if (query) {
            result = this.contacts.filter(function (contact) {
              return contact.id === Number(query) || contact.email && contact.email.indexOf(query) !== -1 || contact.name && contact.name.indexOf(query) !== -1 || contact.surname && contact.surname.indexOf(query) !== -1;
            });
          }
        ...
        value: function updateContact(contact) {
          var index = this.contacts.findIndex(function (_contact) {
    ...
    ContactsProvider = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], ContactsProvider);
    /***/
  }
}]);
