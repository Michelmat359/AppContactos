...
const routes = [
    {
        ...
        children: [
            {
                path: 'contacts',
                loadChildren: () => Promise.all(/*! import() | contacts-contacts-module */[__webpack_require__.e("common"), __webpack_require__.e("contacts-contacts-module")]).then(__webpack_require__.bind(null, /*! ../contacts/contacts.module */ "./src/app/contacts/contacts.module.ts")).then(m => m.ContactsPageModule)
            },
            {
                path: 'search',
